    ...
    if char != "." and char != "0" and char != "1" and char != "2" and char != "3" and char != "4" and char != "5" and char != "6" and char != "7" and char != "8" and char != "9":
        ...
        if index[(position-1)].isnumeric()==True:
            ...
            if index[(position-3)].isnumeric()==True and index[(position-2)].isnumeric()==True:
                left += 1
            if left == 3:
                solution+=int(index[(position-3)]+index[(position-2)]+index[(position-1)])
            if left == 2:
                solution+=int(index[(position-2)]+index[(position-1)])
            if left == 1:
                solution+=int(index[(position-1)])
        # Check Right
        if index[(position+1)].isnumeric()==True:
            right = 1
            if index[(position+2)].isnumeric()==True:
            ...
            if index[(position+3)].isnumeric()==True and index[(position+2)].isnumeric()==True:
                right += 1
            if right == 3:
                solution+=int(index[(position+1)]+index[(position+2)]+index[(position+3)])
            if right == 2:
                solution+=int(index[(position+1)]+index[(position+2)])
            if right == 1:
                solution+=int(index[(position+1)])
        # Check Top Left
        if index[(position-141)].isnumeric()==True:
            ...
            if left == 0 and right == 0:
                solution+=int(index[(position-141)])
            if left == 0 and right == 1:
                solution+=int(index[(position-141)]+index[(position-140)])
                hat = 1
            if left == 0 and right == 2:
                solution+=int(index[(position-141)]+index[(position-140)]+index[(position-139)])
                hat = 1
            if left == 1 and right == 0:
                solution+=int(index[(position-142)]+index[(position-141)])
            if left == 2 and right == 0:
                solution+=int(index[(position-143)]+index[(position-142)]+index[(position-141)])
            if left == 1 and right == 1:
                solution+=int(index[(position-142)]+index[(position-141)]+index[(position-140)])
                hat = 1
        # Check Top Middle
        if index[(position-140)].isnumeric()==True and topleft!=1:
            ...
            if index[(position-138)].isnumeric()==True and index[(position-139)].isnumeric()==True:
                ...
                hat = 1
            if right == 0:
                solution+=int(index[(position-140)])
            if right == 1:
                solution+=int(index[(position-140)]+index[(position-139)])
            if right == 2:
                solution+=int(index[(position-140)]+index[(position-139)]+index[(position-138)])
        #Check Top Right
        if index[(position-139)].isnumeric()==True and topmiddle!=1 and hat!=1:
            ...
            if index[(position-137)].isnumeric()==True and index[(position-138)].isnumeric()==True:
                right += 1
            if right == 0:
                solution+=int(index[(position-139)])
            if right == 1:
                solution+=int(index[(position-139)]+index[(position-138)])
            if right == 2:
                solution+=int(index[(position-139)]+index[(position-138)]+index[(position-137)])
        ...
        if index[(position+139)].isnumeric()==True:
            ...
            if left == 0 and right == 0:
                solution+=int(index[(position+139)])
            if left == 0 and right == 1:
                solution+=int(index[(position+139)]+index[(position+140)])
                snowboard = 1
            if left == 0 and right == 2:
                solution+=int(index[(position+139)]+index[(position+140)]+index[(position+141)])
                snowboard = 1
            if left == 1 and right == 0:
                solution+=int(index[(position+138)]+index[(position+139)])
            if left == 2 and right == 0:
                solution+=int(index[(position+137)]+index[(position+138)]+index[(position+139)])
            if left == 1 and right == 1:
                solution+=int(index[(position+138)]+index[(position+139)]+index[(position+140)])
                snowboard = 1
        # Check Bottom Middle
        if index[(position+140)].isnumeric()==True and bottomleftleft!=1:
            ...
            if right == 0:
                solution+=int(index[(position+140)])
            if right == 1:
                solution+=int(index[(position+140)]+index[(position+141)])
            if right == 2:
                solution+=int(index[(position+140)]+index[(position+141)]+index[(position+142)])
        #Check Bottom Right
        if index[(position+141)].isnumeric()==True and bottommiddle!=1 and snowboard!=1:
            ...
            if right == 0:
                solution+=int(index[(position+141)])
            if right == 1:
                solution+=int(index[(position+141)]+index[(position+142)])
            if right == 2:
                solution+=int(index[(position+141)]+index[(position+142)]+index[(position+143)])
